...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'users.username'
        db.alter_column('TransactionsApp_users', 'username', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'users.username'
        db.alter_column('TransactionsApp_users', 'username', self.gf('django.db.models.fields.CharField')(max_length=10))
